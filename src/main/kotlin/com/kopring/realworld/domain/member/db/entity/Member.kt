...
@Entity
class Member(@Column(nullable = false, unique = true) var email: String, @Column(nullable = false, unique = true) var password: String, @Column(nullable = false) var userName: String, var bio: String?, var image: String?) :
    AuditBase() {
